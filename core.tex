...
\cfrac
 ...
 {\Env, \key{val}\ \vect{tyvar}\ vb\ recvb \vdashD \key{Val}\ (\vect\alpha,cdecs_1,cdecs_2), \VE_1+\VE_2, \compose{\rho_2}{\rho_1}}
\]
...
\cfrac
 ...
 {\Env, \key{datatype}\ \vect{db}\ \key{withtype}\ \vect{tb} \vdashD 
 	\key{Datatype}\ \vect{cdec}, \sum_{j}\TE_j+\sum_{k}\VE_k , \Empty}
\]
...
\cfrac
 {\begin{array}{c}
  ...
  \end{array}}
 {\Env, \key{abstype}\ \vect{db}\ \key{with}\ dec \vdashD \sum_{j}cdec_j+cdec_0, \sum_{j}\TE_j+\TE_0+\VE_0, \rho_0}
\]
...
\cfrac
 ...
 {\begin{array}{ll}
  \Env, \key{exception}\ \vect{vid = longvid} \vdashD & \key{exception}\ \vect{\vcon}, \\
...
\cfrac
 ...
 {\begin{array}{ll}
  \Env, \key{exception}\ \vect{vid \angled{\key{of}\ type}} \vdashD & \key{exception}\ \vect{\vcon}, \\
...
\cfrac
 {\begin{array}{c}
  ...
  \Env_0 = \Env + \sum_i\braced{fn_i \mapsto (v_i, \qualtype{p_i}{\tau_i}, \VKV)} + \vect{\alpha} \qquad
  \rho'_0 = \Empty \\
  \begin{array}{rlll}
...
\cfrac
 ...
 {\Env,\vect{tyvar}, \key{rec}\ \vect{pat = \key{fn}\ match} \vdash_\sVB
    \vect{cpat = cexp}, \sum_i\VE_i, \rho'_n}
\]
...
\cfrac
 {\begin{array}{c}
   ...
   \vect{\alpha} \cap free(\Env) = \emptyset \\
   \Env,pat \vdashP cpat, \VE, \qualtype{p_{1}}{\tau_{1}} \qquad
   \Env+\vect{\alpha}+\VE, match \vdash_\Match cexp, \qualtype{p_2}{\tau_2}, \rho \\
   \unify{[\rho]\tau_{1}}{\tau_{2}}{\rho'} \qquad 
   \rho''=\compose{\rho'}{\rho}				 \qquad   
    [\rho''](p_{1} \cup p_{2})\ \nbkey{holds} \\
  \end{array}}
...
\cfrac
 {\begin{array}{c}
  ...
  \end{array}}
 {\Env, \vect{fn\ pat:type = exp} \vdash_{\sFB_1} 
  fn_1, \vect{cpat},\qualtype{p}{\tau},\VE}
\]
...
\cfrac
 ...
 {\begin{array}{ll}
  \Env,\vect{cpat},\qualtype{p}{\tau\to\tau_0},\vect{fn\ pat:type = exp} \vdash_{\sFB_2}
   & \key{lambda}\ v\ (\key{case}\ v\ \vect{(cpat, cexp)}), \\
...
\prodlhs{corepat}
    ...
    & | & [\vect{\prodlhs{corepat}}]                  								\\
    & | & \braced{\vect{lab = corepat}} 											\\
    & | & \_                                                                        \\
\end{array}
\]}
...
\cfrac
 {\Env,\prodlhs{pat}_i \vdashP cpat_i,\qualtype{p_i}{\tau_i},\VE_i  \qquad
  ...
  \braced{\VE_i}\ \textrm{does not overlap}}
 {\Env, [\vect{pat}] \vdashP
    [\vect{cpat}], [\rho](\qualtype{\sum p_i}{\tau_1\ \textrm{list}}), \sum_i\VE_i}
\]
...
\cfrac
 ...
 {\Env, \braced{\vect{fld}} \vdashP
    \braced{\vect{cfld}}, \qualtype{\sum_i p_i}{\record{\tau_1,\tau_2,\cdots,\tau_n}}, \sum_i\VE_i}
\]
...
\cfrac
 ...
 {\Env, \braced{\vect{fld},\key{...}} \vdashP
    \braced{\vect{cfld}}, \qualtype{\sum_i p_i}{\irecrd{\alpha}{[\tau_1,\tau_2,\cdots,\tau_n]}}, \sum_i\VE_i}
\]
